                    ...
                    <form id="inputForm" class="form-horizontal" action="${ctx}/v/${name}/save/" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="supplyName" name="supplyName" class="form-control" maxlength="50" required/>
                                </div>
                            </div>
                            <div class="form-group db">
                                <label for="supplyAddress" class="col-sm-2 control-label">${cname!}地址</label>
                                <div class="col-sm-10">
                                    <input type="text" id="supplyAddress" name="supplyAddress" class="form-control" maxlength="200" required/>
                                </div>
                            </div>
                            <div class="form-group db">
