<meta charset="utf-8">
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="${ctx.contextPath}/resources/adminLTE/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="${ctx.contextPath}/resources/adminLTE/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="${ctx.contextPath}/resources/adminLTE/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="${ctx.contextPath}/resources/adminLTE/bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<!-- jQuery UI 1.11.4 -->
<script src="${ctx.contextPath}/resources/adminLTE/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="${ctx.contextPath}/resources/adminLTE/bower_components/raphael/raphael.min.js"></script>
<script src="${ctx.contextPath}/resources/adminLTE/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="${ctx.contextPath}/resources/adminLTE/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="${ctx.contextPath}/resources/adminLTE/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="${ctx.contextPath}/resources/adminLTE/bower_components/moment/min/moment.min.js"></script>
<script src="${ctx.contextPath}/resources/adminLTE/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="${ctx.contextPath}/resources/adminLTE/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<script src="${ctx.contextPath}/resources/adminLTE/bower_components/PACE/pace.min.js"></script>
