                    ...
                    <form id="inputForm" class="form-horizontal" action="${ctx}/system/group/save" method="post">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="fullName" name="fullName" class="form-control" required value="${group.fullName!}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="groupType.id" required>
                                        <#list groupTypeList as groupType>
                                            <#if groupType.id == group.groupType.id>
                            ...
                            <div class="form-group db">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="code" name="code" class="form-control" required value="${group.code}"/>
                                </div>
                            </div>
                            <div class="form-group generic">
                                ...
                                <div class="col-sm-10">
                                    <#if group.parent??>
                                        <input type="text" id="pname" name="pname" class="form-control" value="${group.parent.fullName}" disabled/>
                            ...
                            <div class="form-group generic">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="tel" name="tel" class="form-control" value="${group.tel!}"/>
                                </div>
                            </div>
                            <div class="form-group db">
                                <label for="address" class="col-sm-2 control-label">机构地址</label>
                                <div class="col-sm-10">
                                    <input type="text" id="address" name="address" class="form-control" value="${group.address!}"/>
                                </div>
                            </div>
                            <div class="form-group">
