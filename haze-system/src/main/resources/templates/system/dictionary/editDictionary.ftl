    ...
    <div class="row">
        <div class="col-xs-12">
                <div class="box box-info">
                    ...
                    <form id="inputForm" class="form-horizontal" action="${ctx}/system/dictionary/update/" method="post">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="name" class="col-sm-2 control-label">字典名称</label>
                                <div class="col-sm-10">
                                    <input type="text" id="name" name="name" class="form-control" maxlength="20" required value="${dictionary.name!}"/>
                                </div>
                            </div>
                            <div class="form-group db">
                                <label for="code" class="col-sm-2 control-label">字典代码</label>
                                <div class="col-sm-10">
                                    <input type="text" id="code" name="code" class="form-control" maxlength="20" required value="${dictionary.code!}" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <textarea id="remark" name="remark" class="form-control" maxlength="200">${dictionary.description!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="sn" class="col-sm-2 control-label">显示顺序:</label>
                                <div class="col-xs-4">
                                    <input type="number" name="sn" placeholder="请输入显示顺序" class="form-control" value="${dictionary.sn!}"/>
                                </div>
                            </div>
                        </div>
