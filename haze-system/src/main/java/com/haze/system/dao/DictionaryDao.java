...
public interface DictionaryDao extends BaseRepository<Dictionary, Long>, DictionaryRepository {
    ...
    void updateDictionaryIsEnabled(@Param("id") Long id, @Param("isEnabled") Boolean isEnabled);
    ...
    @Query("from Dictionary d where d.parent.id=:parentId and d.isEnabled=true order by d.sn asc")
