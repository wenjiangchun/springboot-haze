...
public interface DictRepository {
     ...
     * <p><b>注意：</b>该方法区别于{@link com.haze.system.dao.DictDao#findByParentCodeAndCode(String parentCode, String code)}</p>
     * @param rootCode 字典所在根节点代码。
     * @param code 字典代码
     * @return 根节点下面所有字典代码=参数code的字典列表
     */
    List<Dict> findByRootCodeAndCode(String rootCode, String code);
