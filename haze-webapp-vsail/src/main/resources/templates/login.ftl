...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/res/vsail/css/login.css" />
    <title>登录页</title>
    <meta charset="UTF-8">
...
<div class="dl">
    <div class="dly" id="dly">
        <div class="dly-title">
            <img src="${ctx}/res/vsail/img/logo.png">智能车联网大数据管理平台
        </div>
        <div class="dly-m">
            <div class="dly-dlk">
                <h5>用户登录</h5>
...
<script src="${ctx}/res/vsail/js/jquery.min.js?v=2.1.4"></script>
<script src="${ctx}/res/vsail/js/bootstrap.min.js?v=3.3.5"></script>
