...
public class VsailConstants {
     ...
     */
    public static final String ROLE_VSAIL_MANAGER = "VSAIL_ADMIN";

    /**
     * 车辆基本信息存放Redis前缀
     */
    public static final String BUS_INFO_KEY_PREFFIX = "bus_";


    public static final String WEB_SOCKET_CONFIG_CODE = "WS_URL";
